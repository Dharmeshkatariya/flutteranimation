...
class FloatingButtonScreen extends StatefulWidget {
  @override
  _FloatingButtonScreenState createState() => _FloatingButtonScreenState();
}

class _FloatingButtonScreenState extends State<FloatingButtonScreen> with SingleTickerProviderStateMixin {
...
class CircularButton extends StatelessWidget {
  ...
  const CircularButton({required this.color, required this.width,required this.height, required this.icon, required this.onClick});
